import telebot
bot = telebot.TeleBot('1337840186:AAEnC2Hyz1c-vruLwQP2DSaJnOUxVWqC2kM')
...
def start_message(message):
    bot.send_message(message.chat.id, '💎Приветствую тебя в нашем магазине💎\n\n👉Для быстрого перемещения по разделам используйте кнопки снизу👇', reply_markup=keyboard)
